...
class Minimalio_Direction_Customizer_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'alpha-color-picker',
			get_template_directory_uri() . '/inc/theme-customizer/js/minimalio-alpha-color-picker.js',
		...
		wp_enqueue_style(
			'alpha-color-picker',
			get_template_directory_uri() . '/inc/theme-customizer/css/minimalio-alpha-color-picker.css',
			[ 'wp-color-picker' ],
			'1.0.0'
		);
	}
